...
class NoSlopForegroundService : Service() {
    ...
    override fun onDestroy() {
        ...
        // Broadcast USER_EXIT gracefully before the app is fully terminated is delegated
        // to higher-level application components in MVP.
    }
